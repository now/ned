...
char *utf_offset_to_pointer(const char *str, unsigned long offset);
unsigned long utf_pointer_to_offset(const char *str, const char *pos);
...
size_t utf_length(const char *str);
size_t utf_length_n(const char *str, size_t len);
